...
import { Calendar, User, ArrowRight, Code, BookOpen, Coffee } from 'lucide-react';
      ...
      <section className="py-24 text-center bg-gradient-to-b from-background to-muted/30">
        <div className="container max-w-4xl mx-auto px-4">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            Insights, tutorials, and best practices from the world of software development. 
            Join me on my journey to build better software.
          </p>
