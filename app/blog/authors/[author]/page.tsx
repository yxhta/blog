...
import { Calendar, User, Clock, ArrowRight, ExternalLink, Github, Twitter, Linkedin } from 'lucide-react';
...
export default async function AuthorPage(props: AuthorPageProps) {
  ...
  const authorPosts = allPosts.filter(post => {
    ...
    return postAuthor === decodedAuthor || 
           (authorInfo && postAuthor === authorInfo.name);
  });
